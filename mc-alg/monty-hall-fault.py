# Monty Hall Problem, but actually the result is around 50%, see if you get confused of why :)
# this is a fake one, used to test students' understanding on Python and monty hall
import random
